...
import {useTooling} from '../../../hooks/MRP/Master/useTooling';

export default function Tooling(){
  const { ToolingData, loading, data, error,ToolingSave,ToolingUpdate }=useTooling();
  ...
  // ----------------------FORMIK SUBMIT /EDIT DATA ----------------------
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try{
        if(isEditing){
          await ToolingUpdate(values.id,values);
        }else{
          await ToolingSave(values);
        }
        await ToolingData();
        resetForm();
        setIsEditing(false);
 ...
 {/* ========================================= TABLE ========================================= */}
  ...
  return(
    ...
    <Card>
      <CardContent>
        {/* ------------ PAGE HEADER ------------ */}
        <Typography>Tooling Master</Typography>
