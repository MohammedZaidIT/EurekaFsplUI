...
import {useSeasonMaster} from '../../../hooks/MRP/Master/useSeasonMaster';

export default function ProductCategory(){
  const { SeasonMasterData, loading, data, error,SeasonMasterSave,SeasonUpdate }=useSeasonMaster();
  ...
  // ----------------------FORMIK SUBMIT /EDIT DATA ----------------------
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try{
        if(isEditing){
          await SeasonUpdate(values.id,values);
        }else{
          await SeasonMasterSave(values);
        }
        await SeasonMasterData();
        resetForm();
        setIsEditing(false);
      }
      catch(err){
 ...
 {/* ========================================= TABLE ========================================= */}
  ...
  return(
    ...
    <Card>
      <CardContent>
        {/* ------------ PAGE HEADER ------------ */}
        <Typography>Season Master</Typography>
