...
import {usePattern} from '../../../hooks/MRP/Master/usePattern';

export default function PatternMaster(){
  const { PatternData, loading, data, error,PatternSave,PatternUpdate }=usePattern();
  ...
  // ----------------------FORMIK SUBMIT /EDIT DATA ----------------------
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try{
        if(isEditing){
          await PatternUpdate(values.id,values);
        }else{
          await PatternSave(values);
        }
        await PatternData();
        resetForm();
        setIsEditing(false);
 ...
 {/* ========================================= TABLE ========================================= */}
  ...
  return(
    ...
    <Card>
      <CardContent>
        {/* ------------ PAGE HEADER ------------ */}
        <Typography>Shoe Pattern</Typography>
