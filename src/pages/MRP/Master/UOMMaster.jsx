...
import {useUOM} from '../../../hooks/MRP/Master/useUOM';

export default function UOMMaster(){
  const { UOMData, loading, data, error,UOMSave,UomUpdate }=useUOM();
  ...
  // ----------------------FORMIK SUBMIT /EDIT DATA ----------------------
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try{
        if(isEditing){
          await UomUpdate(values.id,values);
        }else{
          await UOMSave(values);
        }
        await UOMData();
        resetForm();
        setIsEditing(false);
 ...
 {/* ========================================= TABLE ========================================= */}
  ...
  return(
    ...
    <Card>
      <CardContent>
        {/* ------------ PAGE HEADER ------------ */}
        <Typography>UOM Master</Typography>
