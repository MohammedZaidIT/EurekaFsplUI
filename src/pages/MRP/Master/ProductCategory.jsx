...
import {useProductCategory} from '../../../hooks/MRP/Master/useProductCategory';

export default function ProductCategory(){
  const { ProductCategoryData, loading, data, error,ProductCategorySave,ProductCategoryUpdate }=useProductCategory();
  ...
  // ----------------------FORMIK SUBMIT /EDIT DATA ----------------------
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try{
        if(isEditing){
          await ProductCategoryUpdate(values.id,values);
        }else{
          await ProductCategorySave(values);
        }
        await ProductCategoryData();
        resetForm();
        setIsEditing(false);
      }
      catch(err){
